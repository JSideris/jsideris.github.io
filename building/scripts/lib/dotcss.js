...
//Latest Update.
/*
* Fixed FadeOut when opacity was not set on element.
*/
		...
		if(ops.duration > 0){
			...
			for(var i = 0; i < this.target.length; i++){
				...
				if(ops.hideStyle != "shrink"){
					m++;
					(function(that, t, o){
						return dotcss(t).opacity(0).opacity.animate(0, ops.duration, ops.animationStyle, function(){
