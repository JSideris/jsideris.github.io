var dotUi = new(function(){ this.version = "0.2.0" })();
...
dot.createWidget("tabs", function(tabsArray, customClass, useFragment){
	var first = true;
	useFragment = useFragment ? true : false;
	...
	).class("dot-tabs" + (customClass ? " " + customClass : ""));
	
});

dot.createWidget("fragmentTabs", function(tabsArray, customClass){
	...
	return dot.tabs(tabsArray, customClass, useFragment);
});
