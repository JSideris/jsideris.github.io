...
var researchTab = dot.div(
	...
	.paper("Selective Moving Object Removal for Video", 2012, null, "images/invisiblepeople.jpg",
		"Using a combination of multi-frame pixel subtraction, edge detection, and gradient direction, it was possible to detect, localize, and remove moving objects from video. Applications include removing vehicles from scenes of traffic, and removing instructors from video lectures, especially where the instructor's body or hand is blocking the chalkboard/whiteboard. <i>Note: This study was originally carried out and submitted as an undergraduate whitepaper in 2012. I am currently re-writing it with some upgraded methodologies. Feel free to contact me for more information.</i>",
